...
void VersusAIGameScreen::UpdateGameStatisticsLabel() {
  ...
  m_linesClearedLabel1 ->UpdateText(std::to_string(linesCleared1));
  m_linesClearedLabel2 ->UpdateText(std::to_string(linesCleared2));
  m_levelLabel1        ->UpdateText(std::to_string(level1));
  m_levelLabel2        ->UpdateText(std::to_string(level2));
}
